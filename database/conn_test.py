...
def test_bigquery_connection():
    ...
    Instructions:
    1. Place the service-account.json file in the same directory as this script.
    2. Ensure your Google Cloud Project ID and GA4 dataset ID are correct.
    
    If successful, it will print the first 5 rows of your GA4 data.
    """
    
    # --- Authentication Setup ---
    # This block uses a robust path to find the service account file.
    # It assumes the JSON file is in the same directory as this script.
    try:
